...
const App = () => {
	useDocumentTitle("Cyclopt NIS2 Compliance");
									...
									<main style={{ zIndex: 0, flexGrow: 1, display: "flex", flexDirection: "column" }}>
										...
										>
											<Routes>
												...
												<Route path="organizations/:organizationId/questionnaires/:questionnaireId" element={<Protected c={<Questionnaire />} />} />
												<Route path="organizations/:organizationId/reports" element={<Protected c={<Reports />} />} />
